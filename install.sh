...
installTheme(){
    cd /var/www/
    tar -cvf IceTheme.tar.gz pterodactyl
    echo "Installing theme..."
    cd /var/www/pterodactyl
    rm -r IceTheme
    git clone https://github.com/lrmn7/IceTheme.git
    cd IceTheme
    rm /var/www/pterodactyl/resources/scripts/IceTheme.css
    ...
    mv resources/scripts/IceTheme.css /var/www/pterodactyl/resources/scripts/IceTheme.css
...
repair(){
    bash <(curl https://raw.githubusercontent.com/lrmn7/IceTheme/main/repair.sh)
}

restoreBackUp(){
    echo "Restoring backup..."
    cd /var/www/
    tar -xvf IceTheme.tar.gz
    rm IceTheme.tar.gz
...
printf "${blue}              '             '                                                   '                                    '      \n"
echo ""
echo "Copyright (c) 2022 lrmn7 | lrmn.is-a.dev"
echo "This program is free software: you can redistribute it and/or modify"
echo ""
echo "Discord: https://meww.me/support/"
echo "Website: https://meww.me/"
echo ""
